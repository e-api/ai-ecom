...
@section('content')
  ...
  <div class="carousel col-span-full w-full mx-auto relative group" aria-roledescription="carousel">
    <div class="carousel-track" aria-live="polite">
      ...
      @empty
        <a href="{{ url('listing.html') }}" class="carousel-slide" role="group" aria-roledescription="slide" aria-label="1 of 1" style="background-image: url('https://placehold.co/1600x80?text=•_•&font=lato&auto=format&fit=crop');">
        </a>
      @endforelse
    </div>
